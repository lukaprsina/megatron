...
class QRReader(Node):
    ...
    def load_detector(self):
        try:
            ...
            model_dir = Path(__file__).resolve().parents[2] / "vendor" / "we-chat-qrcode"
            ...
            print("Ensure detect/sr .prototxt and .caffemodel files exist in src/vendor/we-chat-qrcode.")
            exit()
def main(args=None):
