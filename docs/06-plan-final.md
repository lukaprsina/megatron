...
*Verify in sim — mapping may be swapped depending on world orientation.*
...
*Risk: hardcoded yaw values. If world orientation changes, update these.*
*Derive from workstation_pose → line normal in future if needed.*
